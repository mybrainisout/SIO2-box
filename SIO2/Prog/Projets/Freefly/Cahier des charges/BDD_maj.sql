...
(util_id int not null auto_increment,nom text,prenom text, mail varchar(50),user_name varchar(50), mdp varchar(256), constraint pk_utilisateur primary key(util_id));
